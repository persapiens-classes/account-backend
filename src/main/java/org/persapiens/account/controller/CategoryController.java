...
@AllArgsConstructor
public class CategoryController <T extends Category> extends CrudController<CategoryDTO, CategoryDTO, CategoryDTO, String, T, Long> {

	private CategoryService<T> categoryService;
