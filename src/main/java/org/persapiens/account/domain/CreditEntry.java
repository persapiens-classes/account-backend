...
@NoArgsConstructor
@SequenceGenerator(sequenceName = "seq_creditEntry", name = "ID_SEQUENCE", allocationSize = 1)
@Entity
...
@Getter
@Setter
public class CreditEntry extends Entry<EquityAccount, EquityCategory, CreditAccount, CreditCategory> {
