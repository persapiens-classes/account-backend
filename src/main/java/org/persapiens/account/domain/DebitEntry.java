...
@NoArgsConstructor
@SequenceGenerator(sequenceName = "seq_debitEntry", name = "ID_SEQUENCE", allocationSize = 1)
@Entity
...
@Getter
@Setter
public class DebitEntry extends Entry<DebitAccount, DebitCategory, EquityAccount, EquityCategory> {
