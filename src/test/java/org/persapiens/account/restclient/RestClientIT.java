...
class RestClientIT {
	...
	EntryRestClient creditEntryRestClient() {
		return EntryRestClient.builder()
			.restClientHelper(this.<EntryDTO>authenticatedRestClientHelper("creditEntries"))
			.build();
	}

	EntryRestClient debitEntryRestClient() {
		return EntryRestClient.builder()
			.restClientHelper(this.<EntryDTO>authenticatedRestClientHelper("debitEntries"))
			.build();
	}

	EntryRestClient transferEntryRestClient() {
		return EntryRestClient.builder()
			.restClientHelper(this.<EntryDTO>authenticatedRestClientHelper("transferEntries"))
			.build();
	}
