...
public class OwnerTests {
	...
	public void equalNames() {
		assertThat(Owner.builder().name(FATHER).build()).isEqualTo(Owner.builder().name(FATHER).build());
	}
	...
	public void differentNames() {
		assertThat(Owner.builder().name(FATHER).build()).isNotEqualTo(Owner.builder().name(MOTHER).build());
	}
